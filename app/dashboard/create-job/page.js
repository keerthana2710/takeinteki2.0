...
import { createJob } from "@/features/jobs/jobService";
  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center py-24">
        ...
        <h2 className="text-2xl font-extrabold text-on-surface mb-2 font-headline">Job Created!</h2>
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-on-surface font-headline">Create New Job</h1>
          <p className="text-on-surface-variant mt-1">Fill in the details to post a new job</p>
        </div>
      </div>
